...
\restrict y3zcsbPzhTrcKkmc9Y2E2EbXrDYX8Q1MwrLUSBo0NbQNz1SYhTB6muqoJKGay2a
...
ALTER TABLE ONLY public.vehicle_sales DROP CONSTRAINT vehicle_sales_vehicle_id_fkey;
ALTER TABLE ONLY public.vehicle_sales DROP CONSTRAINT vehicle_sales_lead_id_fkey;
ALTER TABLE ONLY public.test_drives DROP CONSTRAINT test_drives_vehicle_id_fkey;
ALTER TABLE ONLY public.test_drives DROP CONSTRAINT test_drives_lead_id_fkey;
ALTER TABLE ONLY public.tasks DROP CONSTRAINT tasks_vehicle_id_fkey;
ALTER TABLE ONLY public.tasks DROP CONSTRAINT tasks_created_by_fkey;
ALTER TABLE ONLY public.tasks DROP CONSTRAINT tasks_assigned_to_fkey;
ALTER TABLE ONLY public.messages DROP CONSTRAINT messages_lead_id_fkey;
ALTER TABLE ONLY public.vehicles DROP CONSTRAINT vehicles_pkey;
ALTER TABLE ONLY public.vehicle_sales DROP CONSTRAINT vehicle_sales_pkey;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_supabase_uid_key;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_email_key;
ALTER TABLE ONLY public.test_drives DROP CONSTRAINT test_drives_pkey;
ALTER TABLE ONLY public.tenant_subscription DROP CONSTRAINT tenant_subscription_pkey;
ALTER TABLE ONLY public.tasks DROP CONSTRAINT tasks_pkey;
ALTER TABLE ONLY public.settings DROP CONSTRAINT settings_pkey;
ALTER TABLE ONLY public.notifications DROP CONSTRAINT notifications_pkey;
ALTER TABLE ONLY public.notices DROP CONSTRAINT notices_pkey;
ALTER TABLE ONLY public.messages DROP CONSTRAINT messages_supabase_id_key;
...
ALTER TABLE ONLY public.leads DROP CONSTRAINT leads_phone_key;
ALTER TABLE ONLY public.expenses DROP CONSTRAINT expenses_pkey;
ALTER TABLE ONLY public.cash_flow DROP CONSTRAINT cash_flow_pkey;
ALTER TABLE ONLY public.attendance DROP CONSTRAINT attendance_user_id_date_key;
...
ALTER TABLE public.vehicle_sales ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.test_drives ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.tenant_subscription ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE public.leaves ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.leads ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.expenses ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.cash_flow ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.attendance ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.vehicles_id_seq;
DROP TABLE IF EXISTS public.vehicles;
DROP SEQUENCE IF EXISTS public.vehicle_sales_id_seq;
DROP TABLE IF EXISTS public.vehicle_sales;
DROP SEQUENCE IF EXISTS public.users_id_seq;
DROP TABLE IF EXISTS public.users;
DROP SEQUENCE IF EXISTS public.test_drives_id_seq;
DROP TABLE IF EXISTS public.test_drives;
DROP SEQUENCE IF EXISTS public.tenant_subscription_id_seq;
DROP TABLE IF EXISTS public.tenant_subscription;
...
\unrestrict y3zcsbPzhTrcKkmc9Y2E2EbXrDYX8Q1MwrLUSBo0NbQNz1SYhTB6muqoJKGay2a
