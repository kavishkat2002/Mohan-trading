  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden print:overflow-visible print:h-auto print:block">
      ...
      <main className="flex-1 flex flex-col overflow-hidden w-full relative print:overflow-visible print:block">
        ...
        <div className="flex-1 overflow-auto p-5 md:p-8 scrollbar-minimal flex flex-col print:overflow-visible print:p-0 print:block">
          <motion.div
            initial={{ opacity: 0, y: 8 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.25, ease: "easeOut" }}
            className="flex-1 print:block"
          >
            {children}
          </motion.div>
          ...
          <footer className="mt-12 pt-4 border-t border-border text-center">
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              Design & Developed By © 2026 <a href="https://www.creativexlab.online/" target="_blank" rel="noopener noreferrer" className="font-medium text-foreground/70 hover:text-primary hover:underline transition-all">Creativex Technology</a> All Rights Reserved.
            </p>
